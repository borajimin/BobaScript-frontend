...
class Question extends React.Component {
  constructor(props) {
    ...
    this.question = {
      ...
      2: "Hello, world",
      3: "Your goal for this question is to get the two cups to have the same value. Everytime you
      pass through the cup left cup, the value of left cup decreases by one. Everytime you pass through the
      right cup, the value of right cup increases by one."
    }
  }
